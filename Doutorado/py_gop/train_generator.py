# -*- coding: utf-8 -*-
"""
Created on Wed Jan 25 10:09:26 2023
...
# Now define data_argument#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
def data_func(data_arguments):
    ...
    x_train = data['x_train'].to_numpy().T
    y_train = data['y_train'].to_numpy().T
